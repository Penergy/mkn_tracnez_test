    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading"><?php echo sprintf(TEXT_NEW_PRODUCT, zen_output_generated_category_path($current_category_id)); //商品分类: "软件">"动作" ?></td>
...
?>
          <tr>
            <td class="main"><?php echo TEXT_MASTER_CATEGORIES_ID; //商品主分类 ?></td>
            <td class="main">
              <?php
...
<?php } ?>
          <tr>
            <td colspan="2" class="main"><?php echo TEXT_INFO_MASTER_CATEGORIES_ID;//备注: 主分类用于定价... ?></td>
          </tr>
          <tr>
...
?>
          ...
          <tr>
            <td class="main"><?php echo TEXT_PRODUCTS_STATUS; //商品状态 ?></td>
...
<?php
  ...
  $dir->close();
  sort($dir_info); // images 下面的folders
...
?>
          ...
          <tr>
            <td class="main" colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                  <!-- 添加4图片同时上传代码-->
                <td class="main"><?php echo TEXT_PRODUCTS_IMAGE."1"; //商品图像 ?></td>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_file_field('products_image_0') . '&nbsp;' . ($pInfo->products_image !='' ? TEXT_IMAGE_CURRENT . $pInfo->products_image : TEXT_IMAGE_CURRENT . '&nbsp;' . NONE) . zen_draw_hidden_field('products_previous_image', $pInfo->products_image); ?></td>
                <!-- 上传目录统一放在一起  -->

              </tr>

              <tr>
                <td class="main"><?php echo TEXT_PRODUCTS_IMAGE."2"; //商品图像 ?></td>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_file_field('products_image_1') . '&nbsp;' . ($pInfo->products_image !='' ? TEXT_IMAGE_CURRENT . $pInfo->products_image : TEXT_IMAGE_CURRENT . '&nbsp;' . NONE) . zen_draw_hidden_field('products_previous_image', $pInfo->products_image); ?></td>
                  <!-- 上传目录统一放在一起  -->

              </tr>

              <tr>
                <td class="main"><?php echo TEXT_PRODUCTS_IMAGE."3"; //商品图像 ?></td>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_file_field('products_image_2') . '&nbsp;' . ($pInfo->products_image !='' ? TEXT_IMAGE_CURRENT . $pInfo->products_image : TEXT_IMAGE_CURRENT . '&nbsp;' . NONE) . zen_draw_hidden_field('products_previous_image', $pInfo->products_image); ?></td>
                  <!-- 上传目录统一放在一起  -->
              </tr>
              <tr>
                <td class="main"><?php echo TEXT_PRODUCTS_IMAGE."4"; //商品图像 ?></td>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_file_field('products_image_3') . '&nbsp;' . ($pInfo->products_image !='' ? TEXT_IMAGE_CURRENT . $pInfo->products_image : TEXT_IMAGE_CURRENT . '&nbsp;' . NONE) . zen_draw_hidden_field('products_previous_image', $pInfo->products_image); ?></td>
                  <!-- 上传目录统一放在一起  -->
              </tr>

              <tr>
                  <td class="main"><?php echo TEXT_PRODUCTS_IMAGE_DIR; ?>&nbsp;<?php echo zen_draw_pull_down_menu('img_dir', $dir_info, $default_directory); ?></td>
              </tr>
              <!-- 新建该产品文件夹 ？？？？-->
              <tr>
